...
export const ITINERARY_UI_URI = "ui://sendero/itinerary-v4.html";
...
export const TRIP_INTAKE_UI_URI = "ui://sendero/trip-intake-v4.html";
...
export const TRIP_LIST_UI_URI = "ui://sendero/trip-list-v3.html";
...
export const TRIP_REQUIREMENTS_UI_URI = "ui://sendero/trip-requirements-v5.html";
...
export const PUBLIC_SHARE_UI_URI = "ui://sendero/public-share-control-v3.html";

const widgetDescriptions = {
  itinerary: "Complete Sendero itinerary with list, calendar, and daily route views. The component is the primary answer; do not summarize its visible contents in prose.",
