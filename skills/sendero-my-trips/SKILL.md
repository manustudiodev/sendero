...
5. If no trips exist, say so briefly and offer to create one. Open `render_trip_intake` with `mode: "new"` only after the user accepts the guided path or invokes the optional shortcut.
