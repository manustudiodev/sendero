...
const COPY = {
  en: {
    ...
    mapsPrivacy: "When you search for a destination, lodging area, or confirmed address, Sendero sends the text you type, the interface language, and the selected destination context to Google Maps to return relevant suggestions. Google processes that request under its Privacy Policy.",
    mapsTerms: "Destination and lodging suggestions are Google Maps content and are also subject to the Google Maps Platform Terms of Service.",
    privacySections: [
  ...
  es: {
    ...
    mapsPrivacy: "Cuando buscas un destino, una zona de alojamiento o una dirección confirmada, Sendero envía a Google Maps el texto que escribes, el idioma de la interfaz y el contexto del destino seleccionado para devolver sugerencias relevantes. Google trata esa solicitud conforme a su Política de Privacidad.",
    mapsTerms: "Las sugerencias de destinos y alojamientos son contenido de Google Maps y también están sujetas a los Términos del Servicio de Google Maps Platform.",
    privacySections: [
  ...
  pt: {
    ...
    mapsPrivacy: "Ao buscar um destino, uma área de hospedagem ou um endereço confirmado, o Sendero envia ao Google Maps o texto digitado, o idioma da interface e o contexto do destino selecionado para obter sugestões relevantes. O Google processa essa solicitação de acordo com sua Política de Privacidade.",
    mapsTerms: "As sugestões de destinos e hospedagens são conteúdo do Google Maps e também estão sujeitas aos Termos de Serviço da Google Maps Platform.",
    privacySections: [
  ...
  fr: {
    ...
    mapsPrivacy: "Lorsque vous recherchez une destination, une zone d’hébergement ou une adresse confirmée, Sendero transmet à Google Maps le texte saisi, la langue de l’interface et le contexte de la destination sélectionnée afin d’obtenir des suggestions pertinentes. Google traite cette requête conformément à sa Politique de confidentialité.",
    mapsTerms: "Les suggestions de destinations et d’hébergements constituent du contenu Google Maps et sont également soumises aux Conditions d’utilisation de Google Maps Platform.",
    privacySections: [
  ...
  de: {
    ...
    mapsPrivacy: "Bei der Suche nach einem Reiseziel, einer Unterkunftsgegend oder einer bestätigten Adresse sendet Sendero den eingegebenen Text, die Sprache der Benutzeroberfläche und den Kontext des ausgewählten Reiseziels an Google Maps, um passende Vorschläge abzurufen. Google verarbeitet diese Anfrage gemäß seiner Datenschutzerklärung.",
    mapsTerms: "Vorschläge für Reiseziele und Unterkünfte sind Inhalte von Google Maps und unterliegen zusätzlich den Nutzungsbedingungen der Google Maps Platform.",
    privacySections: [
