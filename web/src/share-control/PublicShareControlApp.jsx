...
const COPY = {
  ...
  fr: { trip: "Votre voyage", copied: "Lien copié.", copyFailed: "Impossible de le copier. Vous pouvez l’ouvrir et le copier depuis le navigateur.", preview: "Aperçu", exact: "Voici exactement ce que les autres verront", privacy: "Le lien sera public et en lecture seule. Il affichera les titres, descriptions, alternatives et lieux publics, sans l’hébergement exact, les notes privées, les collaborateurs ni l’historique des versions.", until: (value) => ` Il sera disponible jusqu’au ${value}.`, missingPreview: "Nous n’avons pas reçu la vue publique. Préparez-la à nouveau avant de créer le lien.", copy: "Copier le lien", open: "Ouvrir" },
  de: { trip: "Deine Reise", copied: "Link kopiert.", copyFailed: "Der Link konnte nicht kopiert werden. Du kannst ihn öffnen und im Browser kopieren.", preview: "Vorschau", exact: "Genau das werden andere sehen", privacy: "Der Link ist öffentlich und schreibgeschützt. Er zeigt Titel, Beschreibungen, Alternativen und öffentliche Orte, jedoch nicht die genaue Unterkunft, private Notizen, Mitwirkende oder den Versionsverlauf.", until: (value) => ` Er ist bis ${value} verfügbar.`, missingPreview: "Wir haben die öffentliche Ansicht nicht erhalten. Bereite sie vor dem Erstellen des Links erneut vor.", copy: "Link kopieren", open: "Öffnen" },
};
